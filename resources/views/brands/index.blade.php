...
<div class="flex-grow-1">
    ...
    <div class="card">
        <div class="card-datatable table-responsive">
            <table class="datatables-brand table border-top table-striped">
                <thead>
                    <tr>
                        <th></th>
                        <th>Nama</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($brand->logo)
                            <img src="{{ asset('storage/' . $brand->logo) }}" alt="Brand Logo" style="max-height: 50px; object-fit: contain;" />
                            @else
                            No Logo
                            @endif
                        </td>
                        <td>
                            <a href="{{ route('brands.edit', $brand->id) }}" class="btn btn-icon btn-outline-primary edit-button btn-sm custom-btn-color">
                                <span class="bx bx-edit"></span>
                            </a>
                            <button class="btn btn-icon btn-outline-danger delete-button btn-sm" data-brand-id="{{ $brand->id }}">
    ...
    $(document).ready(function() {
        $('.datatables-brand').DataTable({
            ...
            buttons: [
                ...
                {
                text: '<i class="bx bx-plus me-1"></i> Brand',
        ...
        $('div.head-label').html('<h5 class="card-title mb-0">Daftar Merek</h5>');
