    ...
    <div class="row g-6">
        <div class="col-md-6 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="categoryForm" class="row" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-12 mb-3">
                            <x-input-label for="name" :value="__('Nama Kategori')" />
                            <x-text-input id="name" class="form-control" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Masukkan nama kategori" />
