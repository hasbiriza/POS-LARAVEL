...
<div class="flex-grow-1">
    ...
    <div class="card">
        <div class="card-datatable table-responsive">
            <table class="datatables-customers table border-top table-striped">
                <thead>
                    <tr>
                        <th></th>
                        <th>Nama</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('customers.edit', $customer->id) }}" class="btn btn-icon btn-outline-primary edit-button btn-sm custom-btn-color">
                                <span class="bx bx-edit"></span>
                            </a>
                            <button class="btn btn-icon btn-outline-danger delete-button btn-sm" data-customer-id="{{ $customer->id }}">
    ...
    $(document).ready(function() {
        $('.datatables-customers').DataTable({
            ...
            buttons: [
                ...
                {
                text: '<i class="bx bx-plus me-1"></i> Customer',
        ...
        $('div.head-label').html('<h5 class="card-title mb-0">Daftar Customer</h5>');
