...
<div class="flex-grow-1 container-p-y">
    <h4 class="py-3 mb-2">Menu Management</h4>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-style1">
            ...
            <li class="breadcrumb-item">
                <a href="#" class="text-primary">Edit Menu</a>
            </li>
        </ol>
    </nav>
    <div class="row g-6">
                ...
                <div class="card-body">
                    <form id="menuForm" class="row" action="{{ route('menus.update', $menu->id) }}" method="POST">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <x-text-input id="url" class="form-control" type="text" name="url" :value="old('url', $menu->url)" required autocomplete="url" placeholder="Enter menu URL" />
