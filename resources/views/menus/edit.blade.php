    ...
    <div class="row g-6">
        <div class="col-md-6 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="menuForm" class="row" action="{{ route('menus.update', $menu->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <!-- Name -->
                        <div class="col-12 mb-3">
                            <x-input-label for="name" :value="__('Name')" />
                            <x-text-input id="name" class="form-control" type="text" name="name" :value="old('name', $menu->name)" required autofocus autocomplete="name" placeholder="Enter menu name" />
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <x-text-input id="url" class="form-control" type="text" name="url" :value="old('url', $menu->url)" autocomplete="url" placeholder="Enter menu URL" />
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <x-text-input id="icon" class="form-control" type="text" name="icon" :value="old('icon', $menu->icon)" placeholder="Enter menu icon" />
                        ...
                        <div class="col-12 text-center demo-vertical-spacing">
                            <button type="submit" class="btn btn-primary me-sm-3 me-1 custom-btn-color">Save Changes</button>
