...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Detail Retur Pembelian</h5>
        <div>
        ...
        <div class="table-responsive mt-3">
            <table class="table table-bordered table-hover table-totals">
                <tr>
                    ...
                    <td><strong>Rp {{ number_format($return->total_amount, 0, ',', '.') }}</strong></td>
                </tr>
                <tr>
                    <td colspan="6"><strong>Diskon</strong></td>
                    <td><strong>Rp {{ number_format($return->discount, 0, ',', '.') }}</strong></td>
                </tr>
                <tr>
                    <td colspan="6"><strong>Pajak</strong></td>
                    <td><strong>Rp {{ number_format($return->tax, 0, ',', '.') }}</strong></td>
                </tr>
                <tr>
                    <td colspan="6"><strong>Total Retur:</strong></td>
                    <td><strong>Rp {{ number_format($return->total_amount - $return->discount + $return->tax, 0, ',', '.') }}</strong></td>
                </tr>
            </table>
        </div>
...
function cetakInvoice() {
    ...
    var printUrl = '{{ route("purchase-return.cetak-invoice", ":id") }}'.replace(':id', returnId);
