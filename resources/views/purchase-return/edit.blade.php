...
<li class="breadcrumb-item active" aria-current="page">Edit Retur Pembelian</li>
@endsection

@section('content')
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Edit Retur Pembelian</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('purchase-return.update', $return->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row mt-4">
                <div class="col-md-12">
                    ...
                    <div class="row detail-row">
                        ...
                        <div class="col-md-3">
                            <input type="date" class="form-control" name="return_date" value="{{ $return->return_date }}">
                        </div>
                    </div>
                    <div class="row detail-row">
                        <div class="col-md-3 detail-label">No. Invoice Pembelian:</div>
                        <div class="col-md-3">{{ $purchaseTransaction->transaction_id }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input type="hidden" name="return_purchase_detail_id[]" value="{{ $item->return_purchase_detail_id }}">
                                {{ $item->product_name }}
                                <br>
                            ...
                            <td>
                                <input type="number" class="form-control quantity-returned" name="quantity_returned[]" value="{{ $item->quantity_returned }}" min="0" max="{{ $item->quantity_purchased }}" data-price="{{ $item->price }}" data-discount="{{ $item->discount_item }}">
                            </td>
            ...
            <div class="table-responsive mt-3">
                <table class="table table-bordered table-hover table-totals">
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="form-control" name="discount_return" id="discount_return" value="{{ $return->discount }}"></td>
                    </tr>
                    <tr>
                        <td colspan="6"><strong>Pajak</strong></td>
                        <td><input type="number" class="form-control" name="tax_return" id="tax_return" value="{{ $return->tax }}"></td>
                    </tr>
                    <tr>
            ...
            <div class="mt-4">
                ...
                <a href="{{ route('purchase-return.index') }}" class="btn btn-secondary">Batal</a>
            </div>
        </form>
    </div>
</div>
