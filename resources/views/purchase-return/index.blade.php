...
<div class="flex-grow-1">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <!-- <div class="row mb-3">
                <div class="col-12">
                    <a href="{{ route('purchase-return.create') }}" class="btn btn-danger"><i class="bx bx-plus"></i> Buat Retur</a>
                </div>
            </div> -->
    ...
    <div class="card">
        <div class="card-datatable table-responsive">
            <table class="datatables-purchase table border-top table-striped">
                <thead>
                    <tr>
                        <th></th>
                        <th>No. Nota Retur</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ number_format($return->total_amount - $return->discount, 0, ',', '.') }}</td>
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $return->id }}">
                                    <li><a class="dropdown-item" href="{{ route('purchase-return.detail', $return->id) }}">Detail</a></li>
                                    <li><a class="dropdown-item" href="{{ route('purchase-return.edit', $return->id) }}">Edit</a></li>
    ...
    $(document).ready(function() {
        $('.datatables-purchase').DataTable({
            ...
            buttons: [
                ...
                {
                    text: '<i class="bx bx-plus me-1"></i> Retur Pembelian',
                    className: 'btn btn-primary btn-sm custom-btn-color',
                    action: function(e, dt, node, config) {
                        window.location.href = '{{ route("purchase-return.create") }}';
                    }
                }
            ],
        ...
        $('div.head-label').html('<h5 class="card-title mb-0">Daftar Retur Pembelian</h5>');
        ...
        $('.delete-return').on('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('purchase-return.delete', '') }}/" + returnId,
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
                        ...
                        error: function(xhr) {
                            Swal.fire(
                                'Error!',
                                'Terjadi kesalahan saat menghapus retur pembelian.',
                                'error'
                            );
                        }
                    });
