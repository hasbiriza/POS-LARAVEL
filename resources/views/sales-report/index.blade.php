            ...
            <table class="datatables-sales table border-top table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ number_format($transaction->total_sales_after_discount_tax, 0, ',', '.') }}</td>
                        <td>{{ number_format($transaction->total_payment, 0, ',', '.') }}</td>
                        <td>{{ number_format($transaction->remaining_payment, 0, ',', '.') }}</td>
                        <td>{{ number_format($transaction->total_sales_return, 0, ',', '.') }}</td>
...
$(document).ready(function() {
    var table = $('.datatables-sales').DataTable({
        responsive: {
            details: {
    ...
    $('div.head-label').html('<h5 class="card-title mb-0">Laporan Penjualan</h5>');
    ...
    $('#exportExcel').on('click', function() {
        ...
        window.location.href = "{{ route('sales-report.export-excel') }}?start_date=" + start_date + "&end_date=" + end_date + "&store_id=" + store_id;
    });
