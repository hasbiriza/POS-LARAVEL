            ...
            <table class="datatables-roles table border-top table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('suppliers.edit', $supplier->id) }}" class="btn btn-icon btn-outline-primary edit-button btn-sm custom-btn-color">
                                <span class="bx bx-edit"></span>
                            </a>
                            <button class="btn btn-icon btn-outline-danger delete-button btn-sm" data-supplier-id="{{ $supplier->id }}">
    ...
    $(document).ready(function() {
        $('.datatables-roles').DataTable({
            responsive: {
                details: {
                    display: $.fn.dataTable.Responsive.display.modal({
                        header: function(row) {
                            var data = row.data();
                            return 'Supplier Details: ' + data[1];
                        }
                    }),
                    type: 'column',
            ...
            buttons: [
                ...
                {
                text: '<i class="bx bx-plus me-1"></i> Supplier',
        ...
        $('div.head-label').html('<h5 class="card-title mb-0">Daftar Supplier</h5>');
